...
$NXT_ELECT_4 * * *    cd ${SCRIPT_DIR} && ./dnext_elec_time.sh >> ${TON_LOG_DIR}/validator_msig.log
...
$NXT_ELECT_4 * * *    script --return --quiet --append --command "cd ${SCRIPT_DIR} && ./dnext_elec_time.sh >> ${TON_LOG_DIR}/validator_msig.log"
